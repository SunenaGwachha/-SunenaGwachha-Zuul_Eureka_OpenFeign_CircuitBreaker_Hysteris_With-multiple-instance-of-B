...
public class ControllerA {
    ...
    @Autowired
    MyFeignClientB1 myFeignClientB1;
    
    @Autowired
    MyFeignClientB2 myFeignClientB2;
...
//	@HystrixCommand(fallbackMethod = "serviceMayBeDown") // This is usually used in service class OR used where
    ...
    public String communicateB1() {

        return myFeignClientB1.getB1();
    }


    @GetMapping("/callB2FromA")
    public String communicateB2() {

        return myFeignClientB2.getB2();
    }
}